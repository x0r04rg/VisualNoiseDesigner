...
namespace NodeEditorFramework 
{
	...
	public class NodeOutput : NodeKnob
	{
		...
		/// Creates a new NodeOutput in NodeBody of specified type
		/// </summary>
		public static NodeOutput Create(Node nodeBody, string outputName, System.Type outputType)
        {
            return Create(nodeBody, outputName, outputType.AssemblyQualifiedName, NodeSide.Right, 20);
        }
